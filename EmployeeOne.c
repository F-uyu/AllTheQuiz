...
PtrToEmployee searchEmployeeByPhone(PtrToConstEmployee ptr, int tableSize, char * phoneInc){ 
    ...
    { 
        ...
        if(strcmp(ptr->phone,phoneInc) == 0) 
...
PtrToEmployee searchEmployeeBySalary(PtrToConstEmployee ptr, int tableSize, double salaryInc){ 
